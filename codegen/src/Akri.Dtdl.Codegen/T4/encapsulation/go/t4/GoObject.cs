...
namespace Akri.Dtdl.Codegen
{
    ...
    public partial class GoObject : GoObjectBase
    {
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            this.Write("\r\n");
 if (this.schemaImports.Any()) {
            this.Write("\r\nimport (\r\n");
 foreach (var schemaImport in this.schemaImports) { 
            this.Write("\t\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(schemaImport));
            this.Write("\"\r\n");
 } 
            this.Write(")\r\n");
 } 
 ...
 foreach (var fieldInfo in this.objectType.FieldInfos) { 
            ...
            this.Write(" ");
            this.Write(this.ToStringHelper.ToStringWithCulture(GoSchemaSupport.GetType(fieldInfo.Value.SchemaType, fieldInfo.Value.IsRequired)));
            this.Write(" `json:\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(fieldInfo.Key));
            this.Write(this.ToStringHelper.ToStringWithCulture(fieldInfo.Value.IsRequired ? "" : ",omitempty"));
            this.Write("\"`\r\n");
 } 
            this.Write("}\r\n");
