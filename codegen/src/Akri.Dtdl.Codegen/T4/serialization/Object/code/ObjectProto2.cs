namespace Akri.Dtdl.Codegen
{
    ...
    public partial class ObjectProto2 : ITemplateTransform
    {
        ...
        public ObjectProto2(string projectName, string genNamespace, string schema, List<(string, string, DTSchemaInfo, bool, int)> nameDescSchemaRequiredIndices, DtmiToSchemaName dtmiToSchemaName)
        {
