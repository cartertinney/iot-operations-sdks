namespace Akri.Dtdl.Codegen
{
    ...
    public partial class TelemetryProto3 : ITemplateTransform
    {
        ...
        public TelemetryProto3(string projectName, string genNamespace, string schema, List<(string, string, DTSchemaInfo, int)> nameDescSchemaIndices, DtmiToSchemaName dtmiToSchemaName)
        {
