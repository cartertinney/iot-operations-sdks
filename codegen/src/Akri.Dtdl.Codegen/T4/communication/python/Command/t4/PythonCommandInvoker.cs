...
namespace Akri.Dtdl.Codegen
{
    ...
    public partial class PythonCommandInvoker : PythonCommandInvokerBase
    {
        /// <summary>
        ...
        {
            this.Write("# Code generated by Akri.Dtdl.Codegen; DO NOT EDIT.\r\n\r\nfrom communication.Command.C" +
                    "ommandInvoker import CommandInvoker\r\nfrom serialization.");
...
if (this.respSchema != "None" && this.respSchema != "any") {
            ...
            this.Write(" command client\"\"\"\r\n    def __init__(self, mqtt_client, request_topic, model_id =" +
                    " None, custom_topic_token_map = None):\r\n        super(");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
            this.Write("CommandInvoker, self).__init__(");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.reqSchema));
            this.Write(", ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.respSchema));
            this.Write(", mqtt_client, \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.commandName));
            this.Write("\", ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.serializerClassName));
            this.Write(".get_serializer, model_id, request_topic, custom_topic_token_map)\r\n\r\n    async de" +
                    "f invoke_command(self, executor_id,");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.ExtArg()));
            this.Write(" timeout):\r\n        ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.OptRet()));
            this.Write("await self._invoke_command(executor_id, ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.IntArg()));
            this.Write(", timeout)\r\n");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class PythonCommandInvokerBase
    {
        #region Fields
