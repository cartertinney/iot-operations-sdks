...
namespace Akri.Dtdl.Codegen
{
 ...
 if (this.cmdNameReqResps.Any()) { 
            this.Write("\tvar executorOpts protocol.CommandExecutorOptions\r\n\texecutorOpts.ApplyOptions(opt" +
                    "s, serverOpts...)\r\n");
 } 
            this.Write("\r\n");
 if (this.telemSchemas.Any()) { 
            this.Write("\tvar senderOpts protocol.TelemetrySenderOptions\r\n\tsenderOpts.ApplyOptions(opts, s" +
                    "erverOpts...)\r\n");
 } 
            this.Write("\r\n\t");
 ...
 if (this.commandTopic != null) { 
            ...
            this.Write("\t\t},\r\n\t}\r\n\r\n");
 if (this.cmdNameReqResps.Any()) { 
            this.Write("\tvar invokerOpts protocol.CommandInvokerOptions\r\n\tinvokerOpts.ApplyOptions(opts, " +
                    "clientOpts...)\r\n");
 } 
            this.Write("\r\n");
 if (this.telemSchemas.Any()) { 
            this.Write("\tvar receiverOpts protocol.TelemetryReceiverOptions\r\n\treceiverOpts.ApplyOptions(o" +
                    "pts, clientOpts...)\r\n");
 } 
            this.Write("\r\n\t");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.AsLower(this.serviceName)));
