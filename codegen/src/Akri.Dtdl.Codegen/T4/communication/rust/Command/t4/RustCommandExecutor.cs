...
use akri_mqtt::rpc::executor::");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.BaseClassName("CommandExecutor")));
            this.Write(";\r\nuse super::super::serialization::");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.serializerSubNamespace.ToLowerInvariant()));
            this.Write("::");
 ...
 if (this.reqSchema != null && this.reqSchema != string.Empty) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(NamingSupport.ToSnakeCase(this.AsSchema(this.reqSchema))));
            this.Write("::");
 ...
 if (this.respSchema != null && this.respSchema != string.Empty) { 
            this.Write("use super::");
            this.Write(this.ToStringHelper.ToStringWithCulture(NamingSupport.ToSnakeCase(this.AsSchema(this.respSchema))));
            this.Write("::");
            ...
            this.Write("CommandExecutor<TPubSub: PubSub + Send + \'static>(");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.BaseClassName("CommandExecutor")));
            this.Write("<");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.TypeParams()));
            this.Write(this.ToStringHelper.ToStringWithCulture(this.serializerClassName));
            this.Write(", TPubSub>);\r\n\r\nimpl<TPubSub: PubSub + Send + \'static> ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
    ...
    pub fn new(pub_sub: Arc<Mutex<TPubSub>>, demux: Arc<Mutex<InboundMessageDemux<TPubSub>>>, model_id: Option<&'static str>, request_topic: &'static str, custom_topic_token_map: Option<HashMap<String, String>>) -> Self {
        Self(");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.BaseClassName("CommandExecutor")));
            this.Write("::new(pub_sub, demux, \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.commandName));
            this.Write("\", model_id, request_topic, custom_topic_token_map))\r\n    }\r\n}\r\n\r\nimpl<TPubSub: P" +
                    "ubSub + Send + \'static> Deref for ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
            this.Write("CommandExecutor<TPubSub> {\r\n    type Target = ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.BaseClassName("CommandExecutor")));
            this.Write("<");
            ...
            this.Write(", TPubSub>;\r\n\r\n    fn deref(&self) -> &Self::Target {\r\n        &self.0\r\n    }\r\n}\r" +
                    "\n\r\nimpl<TPubSub: PubSub + Send + \'static> DerefMut for ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
