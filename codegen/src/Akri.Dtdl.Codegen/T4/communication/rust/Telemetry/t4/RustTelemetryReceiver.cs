...
use super::super::serialization::");
            ...
            this.Write(";\r\n\r\npub struct ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.schemaClassName));
            this.Write("Receiver<TPubSub: PubSub + Send>(TelemetryReceiver<");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.schemaClassName));
            this.Write(", ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.serializerClassName));
            this.Write(", TPubSub>);\r\n\r\nimpl<TPubSub: PubSub + Send> ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.schemaClassName));
    ...
    pub fn new(pub_sub: Arc<Mutex<TPubSub>>, demux: Arc<Mutex<InboundMessageDemux<TPubSub>>>, model_id: Option<&'static str>, topic: &'static str, custom_topic_token_map: Option<HashMap<String, String>>) -> Self {
        Self(TelemetryReceiver::new(pub_sub, demux, ");
            ...
            this.Write(", TPubSub>;\r\n\r\n    fn deref(&self) -> &Self::Target {\r\n        &self.0\r\n    }\r\n}\r" +
                    "\n\r\nimpl<TPubSub: PubSub + Send> DerefMut for ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.schemaClassName));
