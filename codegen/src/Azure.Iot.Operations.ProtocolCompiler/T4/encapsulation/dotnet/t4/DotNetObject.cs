...
namespace Azure.Iot.Operations.ProtocolCompiler
{
    ...
    public partial class DotNetObject : DotNetObjectBase
    {
        /// <summary>
 ...
 if (this.objectType.Description != null) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(this.needsNullCheck ? " : IJsonOnDeserialized, IJsonOnSerializing": ""));
            this.Write("\r\n    {\r\n");
 ...
 if (fieldInfo.Value.Description != null) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(fieldInfo.Value.IsRequired ? "Never" : "WhenWritingDefault"));
            this.Write(")]\r\n");
 if (fieldInfo.Value.IsRequired) { 
            this.Write("        [JsonRequired]\r\n");
 } 
 if (fieldInfo.Value.Index != null) { 
            this.Write("        [Dahomey.Cbor.Attributes.CborPropertyAttribute(index: ");
            this.Write(this.ToStringHelper.ToStringWithCulture(fieldInfo.Value.Index));
            this.Write(")]\r\n");
 } 
            this.Write("        public ");
            this.Write(this.ToStringHelper.ToStringWithCulture(DotNetSchemaSupport.GetType(fieldInfo.Value.SchemaType)));
            this.Write(this.ToStringHelper.ToStringWithCulture(fieldInfo.Value.IsRequired ? "" : "?"));
            this.Write(" ");
 ...
 if (this.needsNullCheck) { 
            this.Write("        void IJsonOnDeserialized.OnDeserialized()\r\n        {\r\n");
 foreach (var fieldInfo in this.objectType.FieldInfos) { 
