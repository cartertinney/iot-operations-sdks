namespace Azure.Iot.Operations.ProtocolCompiler
{
    ...
    public partial class DotNetTelemetryReceiver : ITemplateTransform
    {
        ...
        public DotNetTelemetryReceiver(CodeName telemetryName, string projectName, CodeName genNamespace, string modelId, CodeName serviceName, string serializerSubNamespace, string serializerClassName, EmptyTypeName serializerEmptyType, ITypeName schemaType)
        {
