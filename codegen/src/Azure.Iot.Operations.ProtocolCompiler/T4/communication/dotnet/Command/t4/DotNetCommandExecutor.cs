...
namespace Azure.Iot.Operations.ProtocolCompiler
{
    ...
    public partial class DotNetCommandExecutor : DotNetCommandExecutorBase
    {
        /// <summary>
            ...
            this.Write(@"
{
    ...
    using ");
            ...
            this.Write("\r\n    {\r\n        /// <summary>\r\n        /// Specializes a <c>CommandExecutor</c> " +
                    "class for Command \'");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.commandName));
            this.Write("\'.\r\n        /// </summary>\r\n");
 if (this.isIdempotent) { 
 if (this.ttl != null) { 
            this.Write("        [CommandBehavior(idempotent: true, cacheableDuration: \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.ttl));
            this.Write("\")]\r\n");
 } else { 
            this.Write("        [CommandBehavior(idempotent: true)]\r\n");
 } 
 } else if (this.ttl != null) { 
            this.Write("        [CommandBehavior(idempotent = false, cacheableDuration: \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.ttl));
            this.Write("\")]\r\n");
 } 
            ...
            this.Write("\r\n        {\r\n            /// <summary>\r\n            /// Initializes a new instanc" +
                    "e of the <see cref=\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
            this.Write("CommandExecutor\"/> class.\r\n            /// </summary>\r\n            internal ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
            this.Write("CommandExecutor(IMqttPubSubClient mqttClient)\r\n                : base(mqttClient," +
                    " \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.commandName));
            this.Write("\", new ");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class DotNetCommandExecutorBase
    {
        #region Fields
