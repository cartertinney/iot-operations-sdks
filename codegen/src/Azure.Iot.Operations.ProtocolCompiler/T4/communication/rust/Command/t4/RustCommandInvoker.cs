...
");
 ...
 if (this.doesCommandTargetExecutor) { 
            this.Write("        executor_id: &str,\r\n");
 } 
            this.Write("    ) -> Result<CommandRequestBuilder<");
            ...
            this.Write(">, SerializerError> {\r\n        let mut builder = CommandRequestBuilder::default()" +
                    ";\r\n        builder.payload(");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.reqSchema != null ? "request" : $"&{this.serializerEmptyType} {{}}"));
            this.Write(").unwrap();\r\n");
 if (this.doesCommandTargetExecutor) { 
            this.Write("        builder.executor_id(Some(executor_id.to_string()));\r\n");
 } 
            this.Write("        Ok(builder)\r\n    }\r\n}\r\n\r\npub struct ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
