...
");
 if (this.reqSchema != null) { 
            ...
            this.Write("use azure_iot_operations_protocol::rpc::command_invoker::{\r\n    CommandInvoker, C" +
                    "ommandInvokerOptionsBuilder, CommandRequest, CommandRequestBuilder,\r\n    Command" +
                    "RequestBuilderError, CommandResponse,\r\n};\r\n\r\n");
 ...
 if (this.reqSchema == null || this.respSchema == null) { 
            ...
            this.Write("Request = CommandRequest<");
            ...
            this.Write(">;\r\npub type ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
            this.Write("RequestBuilderError = CommandRequestBuilderError;\r\n\r\n#[derive(Default)]\r\npub stru" +
                    "ct ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
            this.Write("RequestBuilder {\r\n    inner_builder: CommandRequestBuilder<");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.RequestType()));
            this.Write(">,\r\n");
...
");
 if (this.doesCommandTargetExecutor) { 
            this.Write("    pub fn executor_id(&mut self, executor_id: String) -> &mut Self {\r\n        se" +
                    "lf.inner_builder.executor_id(executor_id);\r\n        self.set_executor_id = true;" +
                    "\r\n        self\r\n    }\r\n\r\n");
 } 
 if (this.reqSchema != null) { 
            ...
            this.Write("Request, ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
            this.Write("RequestBuilderError> {\r\n");
 if (this.doesCommandTargetExecutor) { 
            this.Write("        if !self.set_executor_id {\r\n            return Err(");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
            this.Write("RequestBuilderError::UninitializedField(\r\n                \"executor_id\",\r\n       " +
                    "     ));\r\n        }\r\n\r\n");
 } 
 if (this.reqSchema == null) { 
    ...
    C::PubReceiver: Send + Sync + 'static,
{
    ...
    pub async fn invoke(
        ...
        request: ");
            ...
            this.Write("Request,\r\n    ) -> Result<");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
            this.Write("Response, AIOProtocolError> {\r\n        self.0.invoke(request).await\r\n    }\r\n}\r\n");
