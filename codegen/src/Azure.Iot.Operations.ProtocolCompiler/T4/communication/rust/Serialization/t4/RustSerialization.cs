...
namespace Azure.Iot.Operations.ProtocolCompiler
{
 ...
 if (this.extHeaders.Any()) { 
            this.Write("use azure_iot_operations_protocol::common::payload_serialize::{FormatIndicator, P" +
                    "ayloadSerialize};\r\n");
 foreach (string header in this.extHeaders) { 
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(this.schemaModuleName));
            this.Write("::");
 ...
 if (this.serdeLib != null) { 
            ...
            this.Write("    fn content_type() -> &\'static str {\r\n        \"");
 ...
 if (this.schemaCode != null) { 
            this.Write("\r\n");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.schemaCode));
            this.Write("\r\n\r\nconst RAW_SCHEMA: &str = r#\"\r\n");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.schemaText));
            this.Write("\r\n\"#;\r\n");
 } 
