...
namespace Azure.Iot.Operations.ProtocolCompiler
{
 ...
 foreach (string module in this.modules) { 
            this.Write("mod ");
            this.Write(this.ToStringHelper.ToStringWithCulture(Path.GetFileNameWithoutExtension(module)));
            this.Write(";\r\n");
 } 
 ...
 if (this.telemetryTopic != null) { 
            ...
            this.Write("\r\npub mod client {\r\n");
 foreach (string module in this.modules) { if (!module.EndsWith("_executor") && !module.EndsWith("_serialization")) { 
            this.Write("    pub use super::");
            this.Write(this.ToStringHelper.ToStringWithCulture(module));
            this.Write("::*;\r\n");
 } } 
            this.Write("}\r\n\r\npub mod service {\r\n");
 foreach (string module in this.modules) { if (!module.EndsWith("_invoker") && !module.EndsWith("_serialization")) { 
            this.Write("    pub use super::");
            this.Write(this.ToStringHelper.ToStringWithCulture(module));
            this.Write("::*;\r\n");
 } } 
