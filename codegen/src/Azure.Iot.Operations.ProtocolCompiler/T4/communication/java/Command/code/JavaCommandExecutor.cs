...
namespace Azure.Iot.Operations.ProtocolCompiler
{
    public partial class JavaCommandExecutor : ITemplateTransform
    {
        ...
        public JavaCommandExecutor(string commandName, string genNamespace, string serializerSubNamespace, string serializerClassName, string? reqSchema, string? respSchema)
        {
