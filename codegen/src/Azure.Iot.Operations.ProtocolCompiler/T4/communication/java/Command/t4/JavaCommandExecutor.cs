...
namespace Azure.Iot.Operations.ProtocolCompiler
{
    ...
    public partial class JavaCommandExecutor : JavaCommandExecutorBase
    {
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            this.Write(";\r\n\r\nimport java.util.HashMap;\r\n\r\nimport org.eclipse.paho.mqttv5.client.IMqttAsyn" +
                    "cClient;\r\n\r\nimport DtdlMqtt.Communication.Command.");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.BaseClassName("CommandExecutor")));
            this.Write(";\r\nimport DtdlMqtt.Communication.InboundMessageDemux;\r\nimport DtdlMqtt.Serializat" +
                    "ion.");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.serializerSubNamespace));
            this.Write(".");
            this.Write(this.ToStringHelper.ToStringWithCulture(string.Format(this.serializerClassName, this.SchemaCount())));
            this.Write(";\r\n\r\npublic class ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
            this.Write("CommandExecutor extends ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.BaseClassName("CommandExecutor")));
            this.Write(this.ToStringHelper.ToStringWithCulture(this.TypeParams()));
            this.Write(" {\r\n    ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.capitalizedCommandName));
            this.Write("CommandExecutor(IMqttAsyncClient mqttClient, InboundMessageDemux demux, String re" +
                    "questTopic, String modelId, HashMap<String, String> customTopicTokenMap) throws " +
                    "Exception {\r\n        super(mqttClient, demux, \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.commandName));
            this.Write("\", new ");
            this.Write(this.ToStringHelper.ToStringWithCulture(string.Format(this.serializerClassName, $"{this.SchemaCount()}{this.TypeParams()}")));
            this.Write("(");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.ClassArgs(needDelim:false)));
            this.Write(")");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.ClassArgs(needDelim:true)));
            this.Write(", modelId, requestTopic, customTopicTokenMap);\r\n    }\r\n}\r\n");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class JavaCommandExecutorBase
    {
        #region Fields
