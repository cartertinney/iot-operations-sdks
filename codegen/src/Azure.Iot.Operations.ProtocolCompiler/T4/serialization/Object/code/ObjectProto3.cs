namespace Azure.Iot.Operations.ProtocolCompiler
{
    ...
    public partial class ObjectProto3 : ITemplateTransform
    {
        ...
        public ObjectProto3(string projectName, string genNamespace, string schema, List<(string, string, DTSchemaInfo, bool, int)> nameDescSchemaRequiredIndices, DtmiToSchemaName dtmiToSchemaName)
        {
