...
namespace Azure.Iot.Operations.ProtocolCompiler
{
    ...
    public partial class CommandProto2 : CommandProto2Base
    {
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(this.genNamespace));
            this.Write("\";\r\n\r\n");
 if (ProtobufSupport.TryGetImport(this.paramSchema, this.dtmiToSchemaName, out string importName) && this.importNames.Add(importName)) { 
            this.Write("import \"");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class CommandProto2Base
    {
        #region Fields
