namespace Azure.Iot.Operations.ProtocolCompiler
{
    ...
    public partial class TelemetryProto2 : ITemplateTransform
    {
        ...
        public TelemetryProto2(string projectName, string genNamespace, string schema, List<(string, string, DTSchemaInfo, bool, int)> nameDescSchemaRequiredIndices, DtmiToSchemaName dtmiToSchemaName)
        {
