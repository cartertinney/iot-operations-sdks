...
namespace Azure.Iot.Operations.ProtocolCompiler.IntegrationTests.T4
{
    ...
    public partial class DotNetEnumTokenizer : DotNetEnumTokenizerBase
    {
        /// <summary>
        ...
        public virtual string TransformText()
        {
            ...
            this.Write(";\r\n\r\n    public static class ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.enumSchema.SchemaName));
            this.Write("_Tokenizer\r\n    {\r\n        public static JToken EnumToJToken(");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.enumSchema.SchemaName));
 ...
 foreach (string enumName in this.enumSchema.EnumNames) {
            ...
            this.Write(this.ToStringHelper.ToStringWithCulture(this.enumSchema.SchemaName));
            this.Write(".");
            this.Write(this.ToStringHelper.ToStringWithCulture(Capitalize(enumName)));
            this.Write(" => \"");
            this.Write(this.ToStringHelper.ToStringWithCulture(enumName));
            this.Write("\",\r\n");
 } 
            this.Write("                _ => throw new Exception(\"unrecognized ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.enumSchema.SchemaName));
            this.Write(" value\"),\r\n            });\r\n        }\r\n\r\n        public static ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.enumSchema.SchemaName));
            this.Write(" JTokenToEnum(JToken token)\r\n        {\r\n            return (");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.enumSchema.SchemaName));
            this.Write(")System.Enum.Parse(typeof(");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.enumSchema.SchemaName));
            this.Write("), Capitalize(((JValue)token).Value<string>()));\r\n        }\r\n\r\n        private st" +
                    "atic string Capitalize(string inString) => char.ToUpperInvariant(inString[0]) + " +
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class DotNetEnumTokenizerBase
    {
        #region Fields
