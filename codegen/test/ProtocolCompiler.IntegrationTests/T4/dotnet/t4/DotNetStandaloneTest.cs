...
namespace Azure.Iot.Operations.ProtocolCompiler.IntegrationTests.T4
{
    ...
    public partial class DotNetStandaloneTest : DotNetStandaloneTestBase
    {
        /// <summary>
        ...
        public void TestInitialize()
        {
            ...
            this.Write("ClientShim(emulator.GetClient(SomeClientId), SomeAssetId);\r\n            this.serv" +
                    "iceShim = new ");
            this.Write(this.ToStringHelper.ToStringWithCulture(this.serviceName));
            this.Write("ServiceShim(emulator.GetClient(SomeAssetId));\r\n\r\n            this.clientShim.Star" +
                    "tAsync().Wait();\r\n            this.serviceShim.StartAsync().Wait();\r\n        }\r\n" +
                    "\r\n        [TestMethod]\r\n");
 foreach (string testCaseName in this.testCaseNames) { 
            this.Write("        [DataRow(\"");
            this.Write(this.ToStringHelper.ToStringWithCulture(testCaseName));
            this.Write("\")]\r\n");
 } 
            this.Write(@"        public void DoTest(string testName)
        {
...
");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "17.0.0.0")]
    public class DotNetStandaloneTestBase
    {
        #region Fields
