...
namespace Azure.Iot.Operations.Protocol
{
    ...
    /// </summary>
    /// <param name="serializedPayload">The serialized payload. May be null if no payload was serialized.</param>
    ...
    public class SerializedPayloadContext(byte[]? serializedPayload, string? contentType, MqttPayloadFormatIndicator payloadFormatIndicator)
    {
        /// <summary>
