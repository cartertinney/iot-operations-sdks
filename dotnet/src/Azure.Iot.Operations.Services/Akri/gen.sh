...
rm -rf ./Common
mkdir ./Common
../../../../codegen/src/Azure.Iot.Operations.ProtocolCompiler/bin/Debug/net9.0/Azure.Iot.Operations.ProtocolCompiler --modelFile discovered_resources_commands_v1.json --lang csharp --outDir /tmp/Azure.Iot.Operations.Services.Akri
