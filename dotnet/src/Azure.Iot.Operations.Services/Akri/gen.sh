...
cp -f /tmp/Azure.Iot.Operations.Services.Akri/dtmi_com_microsoft_deviceregistry_DiscoveredAssetResources__1/*.cs dtmi_com_microsoft_deviceregistry_DiscoveredAssetResources__1 -v
