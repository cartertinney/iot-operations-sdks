...
namespace TestEnvoys.dtmi_akri_samples_memmon__1
{
    ...
    public static partial class Memmon
    {
        public abstract partial class Service : IAsyncDisposable
        {
            ...
            private async Task<ExtendedResponse<EmptyAvro>> StartTelemetry_Int(ExtendedRequest<StartTelemetryRequestPayload> req, CancellationToken cancellationToken)
            {
            ...
            private async Task<ExtendedResponse<GetRuntimeStatsResponsePayload>> GetRuntimeStats_Int(ExtendedRequest<GetRuntimeStatsRequestPayload> req, CancellationToken cancellationToken)
            {
