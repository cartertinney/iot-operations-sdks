...
namespace TestEnvoys.dtmi_akri_samples_memmon__1
{
    ...
    public class Object_MemoryStatsBase
    {
        public virtual Schema Schema { get => Schema.Parse(@"{""namespace"":""TestEnvoys.dtmi_akri_samples_memmon__1"",""name"":""Object_MemoryStats"",""type"":""record"",""fields"":[]}"); }
    }

    [System.CodeDom.Compiler.GeneratedCode("Azure.Iot.Operations.ProtocolCompiler", "0.6.0.0")]
    public partial class Object_MemoryStats : Object_MemoryStatsBase, ISpecificRecord
    {
