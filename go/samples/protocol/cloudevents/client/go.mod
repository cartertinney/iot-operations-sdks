module github.com/Azure/iot-operations-sdks/go/samples/protocol/cloudevents/client
...
replace github.com/Azure/iot-operations-sdks/go/samples/protocol/cloudevents/envoy => ../envoy
