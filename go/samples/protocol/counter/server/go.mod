module github.com/Azure/iot-operations-sdks/go/samples/protocol/counter/server
...
replace github.com/Azure/iot-operations-sdks/go/samples/protocol/counter/envoy => ../envoy
