module github.com/Azure/iot-operations-sdks/go/samples/services/statestore

go 1.23.0

require (
	github.com/Azure/iot-operations-sdks/go/mqtt v0.2.0
	github.com/Azure/iot-operations-sdks/go/services v0.1.0
	github.com/lmittmann/tint v1.0.5
)

require (
	github.com/Azure/iot-operations-sdks/go/internal v0.1.0 // indirect
	github.com/Azure/iot-operations-sdks/go/protocol v0.2.0 // indirect
