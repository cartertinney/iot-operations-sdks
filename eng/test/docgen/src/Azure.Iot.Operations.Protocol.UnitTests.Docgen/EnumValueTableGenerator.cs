namespace Azure.Iot.Operations.Protocol.Docgen
{
    ...
    public class EnumValueTableGenerator : IDocumentationGenerator
    {
        ...
        private readonly EnumValueRowGenerator enumValueRowGenerator;

        public EnumValueTableGenerator(XmlElement tableElt, JsonSchemata jsonSchemata, string itemName = "")
        {
            columns = new();

            this.enumValueRowGenerator = new EnumValueRowGenerator(tableElt, jsonSchemata, itemName);
        ...
        public void GenerateDocumentation(MarkdownFile markdownFile)
        {
            ...
            this.enumValueRowGenerator.GenerateRows(markdownFile, columns);
