...
//         supported_major_versions: Vec<ProtocolVersion>,
//     },
//     /// The command invoker received a response that specifies a protocol version that the command invoker doesn't support
