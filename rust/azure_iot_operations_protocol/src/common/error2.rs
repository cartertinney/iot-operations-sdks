...
pub enum TelemetryErrorKind {
    ...
    HeaderInvalid{ header_name: String, header_value: String },
    PayloadInvalid,
    Timeout{ timeout_name: String, timeout_value: Duration },
    Cancellation,
    ConfigurationInvalid{ property_name: String, property_value: Value },
    ArgumentInvalid{ property_name: String, property_value: Value },
    StateInvalid{ property_name: String, property_value: Option<Value> },
    InternalLogicError{ property_name: String, property_value: Option<Value> },
    UnknownError,
    ClientError,
}
